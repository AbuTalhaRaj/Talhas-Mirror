    ...
    if BOT.State.task_going:
        ...
        if is_leech:
            try:
                ...
                Err += f"\n\n<i>⚠️ If You are Unknown with this **ERROR**, Then Forward This Message in [Talha's Supposed Bot](https://t.me/talhasmovie_request_bot) Where [Talha](https://t.me/talhasmovie_request_bot) may fix it</i>"
